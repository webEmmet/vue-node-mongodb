<template>
  <div>
              ...
              <li v-for="item in cartList">
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn"  @click="deleteGoodsModal(item)">
            ...
            <div class="cart-foot-l">
              <div class="item-all-check" >
                <a href="javascript:void(0);" @click="toggleSelectAll">
                  <span class="checkbox-btn item-check-btn" :class="{'check': checkSelectAll}" >
    ...
    <modal :loginAddCart="deleteConfirm" @closeDialog="deleteConfirm=false">
        <p slot="message">
          确认删除商品吗？
          </p>
        <div slot="btnGroup" class="close-btn">
          <el-button type="danger" @click="confirmDelete">确认</el-button>
          <el-button type="info" @click="deleteConfirm=false">关闭</el-button>
        </div>
      </modal>
...
export default{
  ...
  methods: {
    ...
    deleteGoodsModal(item) {
      this.deleteConfirm = true;
      this.productId = item.productId;
      this.delItem = item;
    },
    confirmDelete() {
      api.post('/users/cartDel', {productId: this.productId}).then((res) => {
        console.log(res);
    ...
    toggleSelectAll() {
      var flag = !this.checkSelectAll;
      this.cartList.forEach((item) => {
        item.checked = flag === true ? '1' : '0';
      });
      api.post('/users/editCheckAll', {
        checkAll: flag
      }).then((res) => {
        if (res.data.status === '0') {
